      ...
      <form className="w-full" onSubmit={e => this.props.handleSubmit(e, this.state.question)}>
        <div className="-mx-3 md:flex mb-6">
          <div className="md:w-full px-3">
            <label className="block text-gray-700 text font-bold mb-2" htmlFor="questions-input">
              Question
            </label>
            <input
        ...
        <div className="-mx-3 md:flex mb-6">
          <div className="md:w-full px-3">
            <section className="flex justify-between mb-4">
              <p className="inline-block text-gray-700 font-bold">Answers</p>
              <button
                className="bg-indigo-600 hover:bg-indigo-800 text-white rounded no-underline block py-3 px-4 ml-2 text-xs"
            ...
            {answers.map((answer, index) => {
              return <section className="w-full flex mt-3" key={index}>
                <input
                  className={`appearance-none block w-full bg-gray-200 text-gray-700 ${this.getBorderForValidationState(answer.status)} rounded py-3 px-4`}
                ...
                <button
                  className="bg-red-600 hover:bg-red-800 text-white rounded no-underline block py-3 px-4 ml-2 text-xs"
